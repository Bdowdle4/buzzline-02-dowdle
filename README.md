...
py -m producers.kafka_producer_dowdle
```
...
```zsh
source .venv/bin/activate
python3 -m producers.kafka_producer_dowdle
```
...
```shell
.venv\Scripts\activate
py -m consumers.kafka_consumer_dowdle
```
...
```zsh
source .venv/bin/activate
python3 -m consumers.kafka_consumer_dowdle
```
